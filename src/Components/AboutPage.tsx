    ...
    return (
        <>
            ...
            <ParallaxLayer offset={0.99} speed={0.5}>
                <img src={process.env.PUBLIC_URL + '/page2backgroundPicLightGray.png'} style={{height:"100%", float:"right"}}/>
            </ParallaxLayer>
            ...
            <ParallaxLayer offset={0.99} speed={0.75}>
                <img src={process.env.PUBLIC_URL + '/page2backgroundPicHollow.png'} style={{height:"100%", float: "right"}}/>
            </ParallaxLayer>
